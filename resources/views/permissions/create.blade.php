            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form name="frm_permissions_create" id="frm_permissions_create" action="{{ url('permissions/store') }}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="name">Permission Name</label>
                                    <input type="text" name="name" id="name" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter permission Name here">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" id="description" value="{{old('description')}}" class="form-control @error('description') is-invalid @enderror" placeholder="Enter permission Description here">
                                    @error('description')
...
@section('page-script')
    ...
    <script>
        ...
        $(function() {
            $('#frm_permissions_create').validate({
                rules: {
                    name: {
                        required: true,
                    },
