            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form name="frm_roles_update" id="frm_roles_update" action="{{ url('roles/update/'.$roles->id) }}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="name">Role Name</label>
                                    <input type="text" name="name" id="name" value="{{ $roles->name }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Role Name here">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" id="description" value="{{ $roles->description }}" class="form-control @error('description') is-invalid @enderror" placeholder="Enter Role Description here">
                                    @error('description')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                                                <option value="">Select Option</option>
                                                <option {{ $roles->status == '1' ? 'selected' : '' }} value="1">Active</option>
                                                <option {{ $roles->status == '0' ? 'selected' : '' }} value="0">In-Active</option>
                                            </select>
                                            @error('status')
