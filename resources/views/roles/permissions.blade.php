                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"> Update "{{ $roles->name }}" Roles Permissions Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form name="frm_roles_create" id="frm_roles_create" action="{{ url('roles/update-permissions', $roles->id) }}" method="post">
                            @csrf
                            <div class="card-body">
                                @if ($permissions)
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input class="custom-control-input" name="permissions[]" id="permission-{{ $key }}-{{ $key1 }}" {{ in_array($key.'.'.$val, $role_permissions) ? 'checked' : '' }} type="checkbox" value="{{ $key.'.'.$val }}">
